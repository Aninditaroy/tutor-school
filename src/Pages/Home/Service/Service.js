...
const Service = ({ service }) => {
    ...
    return (
        <>
            <div className="max-w-sm bg-white rounded-lg border border-gray-200 py-6 my-2 hover:shadow-inner shadow-2xl shadow-2xl hover:bg-neutral-100 hover:shadow-stone-200">
